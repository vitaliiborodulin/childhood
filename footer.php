                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('childhood_tel_1', 2); ?>"><?php the_field('childhood_tel_1', 2); ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('childhood_tel_2', 2); ?>"><?php the_field('childhood_tel_2', 2); ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="contacts__mail">
                                Или напишите нам на почту
                                <a href="mailto:<?php the_field('childhood_email', 2); ?>"><?php the_field('childhood_email', 2); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                            <?php echo do_shortcode( '[contact-form-7 id="94" title="Форма отзывов"]' ); ?>
                        </div>
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <div class="reply__form">
                    <?= do_shortcode( '[contact-form-7 id="95" title="Форма вопросов"]' ); ?>
                    ...
                    <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                        <div class="footer__contacts">
                            ...
                            <div class="footer__contacts-item">
                                ...
                                <address><?php the_field('childhood_addr', 2); ?></address>
                            </div>
                        </div>
                    </div>
                </div>
