            ...
            <div class="col-md-6">
                ...
                <div class="contacts__info">
                    <div class="contacts__phones">
                        <div class="contacts__phoneblock">
                            ...
                            <div class="contacts__phonewrap">
                                ...
                                <a
                                    href="tel:<?php the_field('childhood_tel_1', 2); ?>"><?php the_field('childhood_tel_1', 2); ?></a>
                            </div>
                        </div>
                        <div class="contacts__phoneblock">
                            Телефон №2
                            <div class="contacts__phonewrap">
                                ...
                                <a
                                    href="tel:<?php the_field('childhood_tel_2', 2); ?>"><?php the_field('childhood_tel_2', 2); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="contacts__mail">
                        ...
                        <a
                            href="mailto:<?php the_field('childhood_email', 2); ?>"><?php the_field('childhood_email', 2); ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                    ...
                    <div class="glide__track" data-glide-el="track">
                        ...
                        <?php 
                            ...
                            <li class="glide__slide">
                                ...
                                <div class="feedslider__text" style="line-height: 20px">
                                    <?php the_content(); ?>
                                </div>
                            </li>
